...
ULONGLONG ThreadManager::ConvertKernelTime(FILETIME kernelTime)
{
...
DWORD WINAPI ThreadManager::CycleOutputSyncCritical(PVOID pvParam)
{
    ...
    std::ofstream fout(R"(C:\Users\illya\source\repos\ThreadManager\ThreadManager\Log.txt)", std::ios::app);
...
void ThreadManager::on_startButton_clicked() {
    ...
    std::ofstream fout(R"(C:\Users\illya\source\repos\ThreadManager\ThreadManager\Log.txt)", std::ios::trunc);
    fout.close();
